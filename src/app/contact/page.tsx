        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 md:gap-12">
            ...
            <div className="lg:col-span-3">
              <h2 className="text-xl md:text-2xl font-bold text-black mb-4">Send Us a Message</h2>
              ...
              {submitted ? (
                <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
                  ...
                  <button
                    ...
                    className="text-[#FF8C00] font-medium hover:underline text-sm"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF8C00] focus:border-transparent outline-none text-sm"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF8C00] focus:border-transparent outline-none bg-white text-sm"
                      >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#FF8C00] focus:border-transparent outline-none resize-none text-sm"
                      placeholder="Tell us about your security requirements..."
                    />
                  </div>

                  <p className="text-xs text-gray-500">
                    By submitting, you agree to our <Link href="/privacy-policy" className="text-[#FF8C00] hover:underline">Privacy Policy</Link>.
                  </p>

                  <button
                    type="submit" disabled={isSubmitting}
                    className="bg-[#FF8C00] text-white py-3 px-6 rounded font-semibold hover:bg-[#E67E00] transition-colors w-full md:w-auto disabled:opacity-50"
                  >
            ...
            <div className="lg:col-span-2 space-y-4">
              <div className="bg-black text-white rounded-lg p-4">
                ...
                <a href="tel:+447476058050" className="text-[#FF8C00] text-lg font-bold hover:underline">
                  +44 7476 058050
                </a>
              </div>
              ...
              <div className="bg-[#F5F5F5] rounded-lg p-4">
                ...
                <div className="space-y-2 text-sm">
                  <p className="flex items-center text-gray-700">
                    ...
                    <a href="tel:+447476058050" className="hover:text-[#FF8C00]">+44 7476 058050</a>
                  </p>
                  <p className="flex items-center text-gray-700">
                    <svg className="w-4 h-4 text-[#FF8C00] mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    <a href="mailto:contact@asksecurity.co.uk" className="hover:text-[#FF8C00]">contact@asksecurity.co.uk</a>
                  </p>
                </div>
              </div>

              <div className="bg-[#F5F5F5] rounded-lg p-4">
                <h3 className="font-bold text-black mb-2 text-sm">Office Address</h3>
